...
s_geom(2,1) = -1.7500;  s_geom(2,2) =-3.000;   s_geom(2,3) = 0.000;
s_geom(9,1) = -1.7500;  s_geom(9,2) = -1.500;   s_geom(9,3) = 0.000;
s_geom(7,1) = -1.7500;  s_geom(7,2) = 0.000;   s_geom(7,3) = 0.000;
s_geom(5,1) =  -1.7500;  s_geom(5,2) = 1.500;   s_geom(5,3) = 0.000;
...
for ii=1:source;
   ...
   for jj=1:detect;
      ...
      if(sddist(k1)<3.1| sddist(k1)>8.5)%|(ii==7 & jj==2)|(ii==8 & jj==2)
         k1=k1-1;
