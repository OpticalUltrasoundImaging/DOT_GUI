function [Nvxls,v_vol_L,v_vol_N,v_geom,voxel,v_tot,vx,vy,vz,vx1,vy1,vz1,nvx,nvy]...
    = born_sphare1_func (xy_x_radius,xy_y_radius,z_radius,xy_grid,n_depth,rtg,probe_x,probe_y,probe_z,z_step_value)
...
v_vol_L = xy_grid*xy_grid*z_step; % voxel volume
...
v_vol_N = xy_grid_n*xy_grid_n*z_step_n;
p=v_tot;
for z = 1:length(vz1)
    for y = 1:length(vy1)
        for x = 1:length(vx1)
